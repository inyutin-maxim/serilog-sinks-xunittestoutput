...
namespace Serilog
{
    ...
    public static class LoggerConfigurationXunitTestOutputExtensions
    {
        ...
        /// <param name="testOutputHelper">Xunit <see cref="ITestOutputHelper" /> that writes to test output</param>
            ...
            IFormatProvider formatProvider = null)
        {
            ...
            return loggerConfiguration.Sink(new XUnitTestOutputSink(testOutputHelper, formatter),
